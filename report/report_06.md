...
### 23.1 If you have short reads only
...
### 23.3 If you have HiFi + UL-ONT + Hi-C
...
### 23.4 If you have a trio or pedigree

Follow 23.3 for every member, then the de novo procedure in 14.2. Non-negotiable steps: personalised parental reference; two-technology orthogonal support; the 10 kb sliding-window identity filter against distal/proximal misalignment; manual review; gene-conversion annotation of every candidate. Use any further generation as transmission validation.

### 23.5 If you have a Robertsonian or other rearrangement carrier
...
## 24. Reporting standards for acrocentric analyses
